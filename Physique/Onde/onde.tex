...
\begin{document}
    ...
    \subsection*{Calcul intensité}
        ...
        \begin{itemize}
            \item $I_1 = \left(\dfrac{E_1}{r_m}\right)^2$ et $I_2 = \left(\dfrac{E_2}{r_m}\right)^2$ représentent l'intensité reçue en $P$ lorsqu'une seule source émet.
            \item Si $E_1 = E_2 = E_0$, alors $I_{\text{tot}} = 2I_0^2 (1 + \cos(\Delta \Phi)) $.
            \item $\Delta \Phi = k\,(r_2 - r_1) + (\varphi_1 - \varphi_2) = \dfrac{2\pi}{\lambda}(r_2 - r_1) + (\varphi_1 - \varphi_2)$ représente le déphasage entre les deux ondes reçues en $P$.
