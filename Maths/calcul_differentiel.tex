...
\begin{document}
    ...
    \section*{4. Différentielle}
        ...
        La différentielle de $f$ en $a$ est l'application linéaire :

        $$
        df(a):\mathbb{R}^n\to\mathbb{R}
        $$
        ...
        $$
        df_a\in\mathcal{L}(\mathbb{R}^n,\mathbb{R})
        $$
...
\begin{tikzpicture}
  \begin{axis}[samples=30,ticks=none,xlabel={$x$},ylabel={$y$},zlabel={$z$}, title={Point Selle}]
